    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_pic', models.CharField(default='https://img.freepik.com/premium-vector/anime-guy-beach_24911-70757.jpg')),
                ('banner_pic', models.CharField(default='https://img.freepik.com/free-photo/psychedelic-paper-shapes-with-copy-space_23-2149378246.jpg?w=1800&t=st=1685775473~exp=1685776073~hmac=5f072e26cc9a086a94fa84df41dd56e01ba69cdcbf9efd71891a81e6a9059a11')),
                ...
                ('followers', models.ManyToManyField(blank=True, to='app.user')),
                ('following', models.ManyToManyField(blank=True, to='app.user')),
            ],
        ),
        migrations.CreateModel(
            name='Projects',
            fields=[
                ...
                ('bannerImage', models.CharField(blank=True, default='https://t4.ftcdn.net/jpg/03/02/74/89/360_F_302748918_Vs76DTDodjhhkYuCEFahu0LcoDZkBuaW.jpg')),
                ('mainImage', models.CharField(blank=True, default='https://t4.ftcdn.net/jpg/03/02/74/89/360_F_302748918_Vs76DTDodjhhkYuCEFahu0LcoDZkBuaW.jpg')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(blank=True, default='Discussion', max_length=200)),
                ('slug', models.CharField(blank=True, default=None, primary_key=True, serialize=False, unique=True)),
                ('is_closed', models.BooleanField(default=False)),
                ('is_solved', models.BooleanField(default=False)),
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='author', to='app.user')),
                ('upvotes', models.ManyToManyField(blank=True, default=None, related_name='upvotes', to='app.user')),
            ],
        ),
        migrations.CreateModel(
            name='Chat',
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='chat_author', to='app.user')),
                ('forum', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.forum')),
                ('reply', models.ManyToManyField(blank=True, related_name='comment_reply', to='app.chat')),
